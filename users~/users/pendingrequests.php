...
setTimeout(function () {
   window.location.href = "pendingrequests.php"; //will redirect to your blog page (an ex: blog.html)
...
<div class="container">
      ...
      <h3 style="font-weight:800; "> Pending Requests </h3>
      <HR>
...
$cart = mysqli_query($dbc,"SELECT * FROM `requestcart` WHERE `email` = '$email' AND `status` = 'Pending' ");
...
$payment = $rows['paymentstatus'];
   ...
   <tbody class="searchable">
     ...
     <td> <a href="pendingrequests.php?email=<?php echo $emailz; ?>&servicename=<?php echo $servicename; ?>&service_id=<?php echo $id; ?>&subservice_id=<?php echo $subid; ?>&subservicename=<?php echo $subservicename; ?>" class="btn btn-danger btn-sm"> Delete </a>  </td>
