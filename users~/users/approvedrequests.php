...
setTimeout(function () {
   window.location.href = "approvedrequests.php"; //will redirect to your blog page (an ex: blog.html)
...
<div class="container">
      ...
      <h3 style="font-weight:800; "> Approved Requests </h3>
      <HR>
...
$cart = mysqli_query($dbc,"SELECT * FROM `requestcart` WHERE `email` = '$email' AND `status` = 'Approved' ");
...
$payment = $rows['paymentstatus'];
   ...
   <tbody class="searchable">
     ...
     <td> <a href="approvedrequests.php?email=<?php echo $emailz; ?>&servicename=<?php echo $servicename; ?>&service_id=<?php echo $id; ?>&subservice_id=<?php echo $subid; ?>&subservicename=<?php echo $subservicename; ?>" class="btn btn-danger btn-sm"> Delete </a>  </td>
