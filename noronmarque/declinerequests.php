      ...
      <?php include('navbar.php'); ?>
          ...
          <div class="content-wrapper">
            ...
            if(isset($_GET['cartid']) && isset($_GET['email']) && isset($_GET['subservice_id']) && isset($_GET['servicename']) && isset($_GET['subservicename']) ){
                ...
                $update = mysqli_query($dbc, "UPDATE `requestcart` SET `status` = 'Declined' WHERE   `subservice_id` = '$subid' AND `cartid` = '$id'  ");
            ...
            <div class="card" style="padding:20px;">
             ...
             <center>   <img src="https://media1.tenor.com/images/06ae072fb343a704ee80c2c55d2da80a/tenor.gif?itemid=14090897" class="img-fluid" width="300px">
                ...
                <h3> User Request has been <strong style="color:red;"> Declined </strong> </h3>
                
                <a href="managerequests.php" class="btn btn-success btn-sm"> Go back to dashboard </a>
