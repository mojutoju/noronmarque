...
$check = "SELECT * FROM `subservices` WHERE subservicename ='".$subservicename."'";
...
<script>
    ...
    swal({
          text: "Error",
  title: "<?php echo $subservicename; ?> already exists ",
  ...
  button: "Close",
                ...
                $insert = mysqli_query($dbc, "INSERT INTO `subservices` VALUES (NULL,  '$servicename', '$subservicename' , '$description', now()) ");
...
<script>
    ...
    swal({
          text: "Success",
  title: "<?php echo $subservicename; ?> is Added ",
  ...
  button: "Close",
            ...
            <form name="services" method="POST" action="createsubservices.php"  enctype="multipart/form-data">
...
$servicename = $rows['servicename'];
    ...
    <?php $u++; }} ?>
                ...
                <input type="text" class="form-control" style="font-size:13px;" placeholder="Input Sub Service Name" name="subservicename" required> 
