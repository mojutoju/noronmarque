...
<div class="container">
  ...
  $users = mysqli_query($dbc,"SELECT * FROM `users` WHERE email = '$emailz'  ");
...
$allowed =  array('doc', 'docx', 'pdf', 'pptx', 'ppt', 'txt', 'jpg'); //allowed types
...
<?php
    ...
    if($file){
    $location = "docfiles/$file";
    move_uploaded_file($tmp_name, $location);

             
             
                $insert = mysqli_query($dbc, "INSERT INTO `admindocupload` VALUES (NULL, '$cartid'  , '$servicename',  '$subservicename'  ,  '$emailz'  ,  '$fullname'  ,  '$amount' ,  '$file', $size , '$content', '$type', '$location',  now()) ");
...
?>
    ...
    swal({
          text: "Success ",
  title: "<?php echo $file; ?> has been Uploaded ",
...
?>
 ...
 <h4 style="font-weight:800;"> Upload Document for <?php echo $subservicename; ?> </h4>
...
<form name="upload" method="POST" action="uploadfile.php?cartid=<?php echo $id; ?>&email=<?php echo $emailz; ?>&subservice_id=<?php echo $subid; ?>&servicename=<?php echo $servicename; ?>&subservicename=<?php echo $subservicename; ?>&amount=<?php echo $amountz; ?>"  enctype="multipart/form-data">
