...
<script>
  ...
  button: "Close",
   ...
   <?php
    ...
    move_uploaded_file($tmp_name, $location);
                ...
                $insert = mysqli_query($dbc, "INSERT INTO `ebooks` VALUES (NULL, '$docname','$file', $size , '$content', '$type', '$location', '$status' , '$amount', '$description', now()) ");
    ...
    swal({
          text: "Success ",
  title: "<?php echo $docname; ?> has been Uploaded ",
  ...
  button: "Close",
         ...
         ?>
              ...
              <form name="ebooks" method="POST" action="uploadebooks.php"  enctype="multipart/form-data">
                
                
                
                <div class="form-group">
                                    <label style="font-size:14px;"> Document Name / Title </label>
                    <input type="text" name="docname" class="form-control" placeholder="Document Name" style="font-size:13px;" required>
            ...
            <div class="form-group">
                ...
                <input type="text" disabled="disabled" class="form-control" required name="amount" onkeydown="return ( event.ctrlKey || event.altKey || (47<event.keyCode && event.keyCode<58 && event.shiftKey==false) 
                    || (95<event.keyCode && event.keyCode<106)
                    || (event.keyCode==8) || (event.keyCode==9) 
                    || (event.keyCode>34 && event.keyCode<40) 
                    || (event.keyCode==46) )"  id="txtPassportNumber" > 
            </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" style="font-size:13px;"  name="description" cols="30" placeholder="E-book Description..." required></textarea>
