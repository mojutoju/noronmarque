...
$users = mysqli_query($dbc,"SELECT * FROM `videochannel` WHERE `videochannel_id` = '$id' ");
...
$file = $rows['file'];
            ...
            <img src="videocover/<?php echo $file; ?>" class="img-thumbnail">
