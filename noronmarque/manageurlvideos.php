...
if($_SESSION["login"] != null){
          ...
          <div class="content-wrapper">
            ...
            <hr>
                  ...
                  if(isset($_GET['url_id'])){
                      ...
                      $delete = mysqli_query($dbc, "DELETE FROM `urlvideos` WHERE `url_id` = '$id' ");
 ...
 window.location.href = 'manageurlvideos.php';
</script>  
...
$users = mysqli_query($dbc,"SELECT * FROM `urlvideos` WHERE 1  ");
...
$description = $rows['description'];
   ...
   <td><?php echo $subtitle; ?></td>
        <td> <a href="viewurlvideos.php?url_id=<?php echo $vid; ?>" class="btn btn btn-sm" style="background:blue; color:white;">  View </a> </td>
        <td> <a href="manageurlvideos.php?url_id=<?php echo $vid; ?>" class="btn btn btn-sm" style="background:red; color:white;">  Delete </a> </td>
