...
if($_SESSION["login"] != null){
          ...
          <div class="content-wrapper">
            ...
            <hr>
                  ...
                  if(isset($_GET['subservice_id'])){
                      ...
                      $delete = mysqli_query($dbc, "DELETE FROM `subservices` WHERE `subservice_id` = '$id' ");
 ...
 window.location.href = 'managesubservices.php';
</script>  
  ...
  $subservicename = $rows['subservicename'];
   ...
   <tbody class="searchable">
      <tr>
        ...
        <td> <a href="editsubservices.php?subservice_id=<?php echo $id; ?>" class="btn btn btn-sm" style="background:blue; color:white;">  Edit </a> </td>
     
        <td> <a href="viewsubservices.php?subservice_id=<?php echo $id; ?>" class="btn btn-success btn-sm"> View </a></td>
        <td> <a href="managesubservices.php?subservice_id=<?php echo $id; ?>" class="btn btn-danger btn-sm"> Delete </a> </td>
