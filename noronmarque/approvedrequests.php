...
<div class="card">
  ...
  <table class="table table-hover table-bordered">
    <thead>
      <tr>
        <th scope="col">Service Type(s)</th>
...
$users = mysqli_query($dbc,"SELECT * FROM `requests` WHERE `status` = 'Approved'  ");
...
<!-- Basic dropdown -->  </td>
        <td> <a href="viewrequests.php?request_id=<?php echo $id; ?>" class="btn btn btn-sm" style="background:blue; color:white;">  View </a> </td>
