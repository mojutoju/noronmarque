...
if(isset($_GET['id'])){
 ...
 window.location.href = 'pendingusers.php';
</script>  
...
$users = mysqli_query($dbc,"SELECT * FROM `users` WHERE status = 'pending'  ");
...
<div class="dropdown-menu">
  ...
  <a class="dropdown-item" href="declineusers.php?id=<?php echo $id; ?>">Unapprove</a>
    <a class="dropdown-item" href="pendingusers.php?id=<?php echo $id; ?>">Delete</a>
</div>
<!-- Basic dropdown -->  </td>
