...
$users = mysqli_query($dbc,"SELECT * FROM `facilitators` WHERE `fac_id` = '$id'  ");
 ...
 while($rows = mysqli_fetch_assoc($users)){
  ...
  $fname = $rows['fname'];
            ...
            <div class="col-md-6 mb-2">
                ...
                <img src="facilitators/<?php echo $file; ?>" class="img-fluid img-thumbnail">
